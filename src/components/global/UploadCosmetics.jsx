...
const UploadCosmetics = () => {
    ...
    const fetchCosmetics = async () => {
        ...
        try {
            ...
            const response = await axios.get("https://demo-deployment2-15-syk7.onrender.com/admin/cosmetics", {
                headers: {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            await axios.post("https://demo-deployment2-15-syk7.onrender.com/admin/upload/cosmetics", formData, {
                headers: {
    ...
    const handleDelete = async (id) => {
        ...
        const token = localStorage.getItem("token");
        try {
            await axios.delete(`https://demo-deployment2-15-syk7.onrender.com/admin/delete/cosmetics/${id}`, {
                headers: {
                    Authorization: `Bearer ${token}`,
                },
            });
    ...
    const handleEdit = async (e) => {
        ...
        try {
            const response = await axios.put(
                `https://demo-deployment2-15-syk7.onrender.com/admin/update/cosmetics/${selectedCosmetic.id}`,
                formData,
                {
                    headers: {
                        "Content-Type": "multipart/form-data",
