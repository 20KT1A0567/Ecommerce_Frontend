...
const UploadMobiles = () => {
    ...
    const fetchMobiles = async () => {
        ...
        try {
            ...
            const response = await axios.get(
                "https://demo-deployment2-5-zlsf.onrender.com/admin/mobiles",
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const token = localStorage.getItem("token");
            await axios.post(
                "https://demo-deployment2-5-zlsf.onrender.com/admin/upload/mobiles",
                formData,
                {
                    headers: {
    ...
    const handleDelete = async (id) => {
        ...
        try {
            const token = localStorage.getItem("token");
            await axios.delete(
                `https://demo-deployment2-5-zlsf.onrender.com/admin/delete/mobiles/${id}`,
                { headers: { Authorization: `Bearer ${token}` } }
            );
    ...
    const handleEdit = async (e) => {
        ...
        try {
            ...
            const response = await axios.put(
                `https://demo-deployment2-5-zlsf.onrender.com/admin/update/mobiles/${selectedMobile.id}`,
                formData,
                {
                    headers: {
                        "Content-Type": "multipart/form-data",
