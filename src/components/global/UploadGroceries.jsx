...
const UploadGroceries = () => {
    ...
    const fetchGroceries = async () => {
        ...
        try {
            ...
            const response = await axios.get("https://demo-deployment2-5-zlsf.onrender.com/admin/grocery", {
                headers: {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            await axios.post("https://demo-deployment2-5-zlsf.onrender.com/admin/upload/grocery", formData, {
                headers: {
    ...
    const handleDelete = async (id) => {
        ...
        const token = localStorage.getItem("token");
        try {
            await axios.delete(`https://demo-deployment2-5-zlsf.onrender.com/admin/delete/grocery/${id}`, {
                headers: {
                    Authorization: `Bearer ${token}`,
                },
            });
    ...
    const handleEdit = async (e) => {
        ...
        try {
            const response = await axios.put(
                `https://demo-deployment2-5-zlsf.onrender.com/admin/update/grocery/${selectedGrocery.id}`,
                formData,
                {
                    headers: {
                        "Content-Type": "multipart/form-data",
