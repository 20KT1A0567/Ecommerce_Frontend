...
const UploadFootwear = () => {
    ...
    const fetchFootwear = async () => {
        ...
        try {
            ...
            const response = await axios.get("https://demo-deployment2-7-bbpl.onrender.com/admin/footwear", {
                headers: {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            await axios.post("https://demo-deployment2-7-bbpl.onrender.com/admin/upload/footwear", formData, {
                headers: {
    ...
    const handleDelete = async (id) => {
        ...
        const token = localStorage.getItem("token");
        try {
            await axios.delete(`https://demo-deployment2-7-bbpl.onrender.com/admin/delete/footwear/${id}`, {
                headers: {
                    Authorization: `Bearer ${token}`,
                },
            });
    ...
    const handleEdit = async (e) => {
        ...
        try {
            const response = await axios.put(
                `https://demo-deployment2-7-bbpl.onrender.com/admin/update/footwear/${selectedFootwear.id}`,
                formData,
                {
                    headers: {
                        "Content-Type": "multipart/form-data",
