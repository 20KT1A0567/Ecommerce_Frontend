...
const uploadFootwear = () => {
    ...
    const fetchCosmetics = async () => {
        try {
            ...
            const response = await axios.get("https://demo-deployment2-12.onrender.com/admin/footwear", {
                headers: {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            await axios.post("https://demo-deployment2-12.onrender.com/admin/upload/footwear", formData, {
                headers: {
    ...
    const handleDelete = async (id) => {
        const token = localStorage.getItem("token");
        try {
            await axios.delete(`https://demo-deployment2-12.onrender.com/admin/delete/footwear/${id}`, {
                headers: {
                    Authorization: `Bearer ${token}`,
                },
            });
    ...
    const handleEdit = async (e) => {
        ...
        try {
            const response = await axios.put(
                `https://demo-deployment2-12.onrender.com/admin/update/footwear/${selectedCosmetic.id}`,
                formData,
                {
                    headers: {
                        "Content-Type": "multipart/form-data",
                ...
                <div className="modal-overlay">
                    <div className="modal-content">
                        ...
                        <form onSubmit={handleSubmit} className="upload-cosmetics-form">
                            ...
                            <button type="submit">Upload Footwear</button>
                ...
                <div className="modal-overlay">
                    <div className="modal-content">
                        ...
                        <form onSubmit={handleEdit} className="upload-cosmetics-form">
                            ...
                            <button type="submit">Update Footwear</button>
