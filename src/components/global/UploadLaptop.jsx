...
const UploadLaptop = () => {
    ...
    const fetchLaptops = async () => {
        ...
        try {
            ...
            const response = await axios.get("https://demo-deployment2-5-zlsf.onrender.com/admin/laptops", {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const token = localStorage.getItem("token");
            await axios.post("https://demo-deployment2-5-zlsf.onrender.com/admin/upload/laptops", formData, {
                headers: {
    ...
    const handleDelete = async (id) => {
        ...
        try {
            const token = localStorage.getItem("token");
            await axios.delete(`https://demo-deployment2-5-zlsf.onrender.com/admin/delete/laptops/${id}`, {
                headers: { Authorization: `Bearer ${token}` },
            });
    ...
    const handleEdit = async (e) => {
        ...
        try {
            ...
            const response = await axios.put(
                `https://demo-deployment2-5-zlsf.onrender.com/admin/update/laptops/${selectedLaptop.id}`,
                formData,
                {
                    headers: {
                        "Content-Type": "multipart/form-data",
