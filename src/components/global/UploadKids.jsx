...
const uploadKids = () => {
    ...
    const fetchCosmetics = async () => {
        try {
            ...
            const response = await axios.get("https://demo-deployment2-5.onrender.com/admin/kids", {
                headers: {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            await axios.post("https://demo-deployment2-5.onrender.com/admin/upload/kids", formData, {
                headers: {
    ...
    const handleDelete = async (id) => {
        const token = localStorage.getItem("token");
        try {
            await axios.delete(`https://demo-deployment2-5.onrender.com/admin/delete/kids/${id}`, {
                headers: {
                    Authorization: `Bearer ${token}`,
                },
            });
    ...
    const handleEdit = async (e) => {
        ...
        try {
            const response = await axios.put(
                `https://demo-deployment2-5.onrender.com/admin/update/kids/${selectedCosmetic.id}`,
                formData,
                {
                    headers: {
                        "Content-Type": "multipart/form-data",
