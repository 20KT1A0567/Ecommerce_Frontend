...
const UploadKids = () => {
    ...
    const fetchItems = async () => {
        ...
        try {
            ...
            const response = await axios.get("https://demo-deployment2-15-syk7.onrender.com/admin/kids", {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const token = localStorage.getItem("token");
            await axios.post("https://demo-deployment2-15-syk7.onrender.com/admin/upload/kids", formData, {
                headers: {
    ...
    const handleDelete = async (id) => {
        ...
        try {
            const token = localStorage.getItem("token");
            await axios.delete(`https://demo-deployment2-15-syk7.onrender.com/admin/delete/kids/${id}`, {
                headers: { Authorization: `Bearer ${token}` },
            });
    ...
    const handleEdit = async (e) => {
        ...
        try {
            ...
            const response = await axios.put(
                `https://demo-deployment2-15-syk7.onrender.com/admin/update/kids/${selectedItem.id}`,
                formData,
                {
                    headers: {
                        "Content-Type": "multipart/form-data",
