...
const Displayelectronics = () => {
  ...
  if (!item) {
    return <h1>Electronics Details not found.</h1>;
  }
  ...
  const handleAddToCart = async () => {
    ...
    try {
      const response = await axios.post(
        `https://demo-deployment2-12.onrender.com/api/cart/add/${userId}/electronics/${item.id}`,
        null,
        { 
          params: { qty: quantity },
          headers: {
      ...
      <div className="cosmetic-container">
        ...
        <div className="cosmetic-card">
          <img
            ...
            alt={item.name || "Electronics Image"}
