...
const Women1 = () => {
    ...
    const getElectronics = async () => {
        try {
            const res = await axios.get("https://demo-deployment2-12.onrender.com/women");
    ...
    const handleAddToCart = (event, item) => {
        ...
        axios.post("https://demo-deployment2-12.onrender.com/women", item, {
    ...
    return (
        <>
            ...
            <div className="product-container">
                {loading ? (
                    <div className="loading-message">Loading  Women...</div>
                ) : error ? (
                    ...
                    <div className="no-data-message">No  Women available.</div>
                )}
            </div>
        </>
    );
