...
const Laptops1 = () => {
    ...
    const getElectronics = async () => {
        try {
            const res = await axios.get("https://demo-deployment2-11.onrender.com/laptops");
    ...
    const handleAddToCart = (event, item) => {
        ...
        axios.post("https://demo-deployment2-11.onrender.com/laptops", item, {
    ...
    return (
        <>
            ...
            <div className="product-container">
                {loading ? (
                    <div className="loading-message">Loading  Laptops...</div>
                ) : error ? (
                    ...
                    <div className="no-data-message">No  Laptops available.</div>
                )}
            </div>
        </>
    );
