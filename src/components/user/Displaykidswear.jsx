...
const Displaykidswear = () => {
    ...
    if (!item) {
        return <h1>Kidswear Details not found.</h1>;
    }
    ...
    const handleAddToCart = async () => {
        ...
        try {
            const response = await axios.post(
                `https://demo-deployment2-12.onrender.com/api/cart/add/${userId}/kids/${item.id}`,
                null,
                { 
                    params: { qty: quantity },
                    headers: {
...
export default Displaykidswear;