...
const Men1 = () => {
    ...
    const getElectronics = async () => {
        try {
            const res = await axios.get("https://demo-deployment2-11.onrender.com/men");
    ...
    const handleAddToCart = (event, item) => {
        ...
        axios.post("https://demo-deployment2-11.onrender.com/men", item, {
    ...
    return (
        <>
            ...
            <div className="product-container">
                {loading ? (
                    <div className="loading-message">Loading  Men...</div>
                ) : error ? (
                    ...
                    <div className="no-data-message">No  Men available.</div>
                )}
            </div>
        </>
    );
