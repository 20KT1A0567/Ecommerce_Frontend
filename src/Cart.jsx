...
const Cart = () => {
  ...
  const handlePayment = async () => {
    try {
      const orderResponse = await axios.post("https://demo-deployment2-9.onrender.com/createOrder", {
        userId,
      ...
      const options = {
        ...
        handler: async (response) => {
          try {
            const verifyResponse = await axios.post("https://demo-deployment2-9.onrender.com/paymentCallback", {
  ...
  useEffect(() => {
    const fetchCart = async () => {
      ...
      try {
        const response = await axios.get(`https://demo-deployment2-9.onrender.com/api/cart/${userId}`);
  ...
  const handleQuantityChange = async (itemId, newQty) => {
    ...
    try {
      await axios.put(`https://demo-deployment2-9.onrender.com/api/cart/update/${userId}/${itemId}`, null, { params: { qty: newQty } });
  ...
  const handleRemoveItem = async (itemId) => {
    try {
      await axios.delete(`https://demo-deployment2-9.onrender.com/api/cart/delete/${userId}/${itemId}`);
